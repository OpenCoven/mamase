...
npm run lab -- prepare --recipe /path/recipe.json --dataset /path/examples.jsonl --identity-dir /path/familiar --out .lab/experiment</pre>
      <p>Use the PEFT environment from <code>training/requirements-peft.txt</code>, separate from managed MLX. Check the prepared bundle and local safetensors model without loading weights:</p>
